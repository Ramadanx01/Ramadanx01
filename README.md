...
<!-- Banner -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:020024,100:090979&height=220&section=header&text=Mohamed%20Ramadan&fontSize=42&fontColor=ffffff" />
</p>

<!-- Profile Views -->
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=Ramadanx01&color=blue&style=flat-square" />
</p>
...
## 🎯 UI Libraries  
![SweetAlert2](https://img.shields.io/badge/SweetAlert2-FF5F5F?style=for-the-badge)
...
{
    public array $skills = [
        "Backend" => ["PHP", "MySQL", "Node.js", "System Architecture"],
        "Frontend" => ["HTML", "CSS", "JavaScript", "Tailwind", "Bootstrap"],
        "UI Libraries" => ["SweetAlert2", "Remix Icon"],
        "Tools" => ["Git", "GitHub", "VS Code", "Figma", "Postman"],
        "References" => ["W3Schools", "MDN", "StackOverflow"]
    ];
}
